...
\begin{figure}[h]
    ...
    \end{subfigure}
	\caption[Empirical \gls{PDF} of error in \gls{ORBSLAM} relative measurement]{Empirical \gls{PDF} of error in \gls{ORBSLAM} relative measurement. Blue: empirical \gls{PDF} (histogram), Orange: Gaussian distribution with the same variance.}
...
Functionality demonstration using actual sensors is highly unlikely to be achieved under the given circumstances and the time frame.
