...
\begin{figure}[h]
    ...
    \end{subfigure}
    \vspace{-0.5cm}
	\caption[Empirical \gls{PDF}s of errors in \gls{ORBSLAM} relative measurements]{Empirical \gls{PDF}s of errors in \gls{ORBSLAM} relative measurements. Blue: empirical \gls{PDF} (histogram), Orange: Gaussian distribution with the same variance.}
...
\begin{figure}[h]
    ...
    \end{subfigure}
    \vspace{-0.5cm}
	\caption[Empirical \gls{PDF}s of errors in \gls{LeGO-LOAM} relative measurements]{Empirical \gls{PDF}s of errors in \gls{LeGO-LOAM} relative measurement. Blue: empirical \gls{PDF} (histogram), Orange: Gaussian distribution with the same variance.}
