...
def write_gps(gps, i, bag):
    ...
    bag.write(Constants.NCLT_RAW_DATA_GNSS_FIX_TOPIC, fix, t=timestamp)
    bag.write(Constants.NCLT_RAW_DATA_GNSS_TRACK_TOPIC, track, t=timestamp)
    bag.write(Constants.NCLT_RAW_DATA_GNSS_SPEED_TOPIC, speed, t=timestamp)
...
def write_gps_rtk(gps, i, bag):
    ...
    bag.write(Constants.NCLT_RAW_DATA_RTK_GNSS_FIX_TOPIC, fix, t=timestamp)
    bag.write(Constants.NCLT_RAW_DATA_RTK_GNSS_TRACK_TOPIC, track, t=timestamp)
    bag.write(Constants.NCLT_RAW_DATA_RTK_GNSS_SPEED_TOPIC, speed, t=timestamp)
...
def write_ms25(ms25, i, bag):
    ...
    mag.magnetic_field.x = mag_x / 10000
    mag.magnetic_field.y = mag_y / 10000
    mag.magnetic_field.z = mag_z / 10000
    ...
    imu.angular_velocity.x = rot_r
    imu.angular_velocity.y = rot_p
    imu.angular_velocity.z = rot_h

    bag.write(Constants.NCLT_RAW_DATA_MAGNETOMETER_TOPIC, mag, t=timestamp)
    bag.write(Constants.NCLT_RAW_DATA_IMU_TOPIC, imu, t=timestamp)
