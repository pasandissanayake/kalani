...
def gnss_callback(data):
    ...
    if gnss.fix_mode == 3:
        if kf.is_initialized():
            ...
            p = np.array([107.724666287, 75.8293395278, 3.27289462581])
            # cov_p = nclt_gnss_var
            ...
            gb = np.zeros(2) + fix[0:2] - p[0:2]
            cov_gb = gw_var * np.ones(2)
