...
class ReadSensorData(BaseRawData):
    ...
    def read_gps_csv(self, all_in_one=None):
        ...
        if self.sensor_data_flag:
            ...
            gps = np.loadtxt(self.sensor_data_dir + '/gps.csv', delimiter=",")
    ...
    def read_gps_rtk_csv(self, all_in_one=None):
        ...
        if self.sensor_data_flag:
            ...
            gps_rtk = np.loadtxt(self.sensor_data_dir + '/gps_rtk.csv', delimiter=",")
    ...
    def read_gps_rtk_err_csv(self, all_in_one=None):
        ...
        if self.sensor_data_flag:
            ...
            gps_rtk_err = np.loadtxt(self.sensor_data_dir + '/gps_rtk_err.csv', delimiter=",")
    ...
    def read_kvh_csv(self, all_in_one=None):
        ...
        if self.sensor_data_flag:
            ...
            kvh = np.loadtxt(self.sensor_data_dir + '/kvh.csv', delimiter=",")
    ...
    def read_ms25_csv(self, all_in_one=None):
        ...
        if self.sensor_data_flag:
            ...
            ms25 = np.loadtxt(self.sensor_data_dir + '/ms25.csv', delimiter=",")
    ...
    def read_ms25_euler_csv(self, all_in_one=None):
        ...
        if self.sensor_data_flag:
            ...
            ms25_euler = np.loadtxt(self.sensor_data_dir + '/ms25.csv', delimiter=",")
    ...
    def read_odometry_cov_csv(self, all_in_one=None):
        ...
        if self.sensor_data_flag:
            ...
            odom_cov = np.loadtxt(self.sensor_data_dir + '/odometry_cov.csv', delimiter=",")
    ...
    def read_odometry_cov_100hz_csv(self, all_in_one=None):
        ...
        if self.sensor_data_flag:
            ...
            odom_cov = np.loadtxt(self.sensor_data_dir + '/odometry_cov_100hz.csv', delimiter=",")
    ...
    def read_odometry_mu_csv(self, all_in_one=None):
        ...
        if self.sensor_data_flag:
            ...
            odom = np.loadtxt(self.sensor_data_dir + '/odometry_mu.csv', delimiter=",")
    ...
    def read_odometry_mu_100hz_csv(self, all_in_one=None):
        ...
        if self.sensor_data_flag:
            ...
            odom = np.loadtxt(self.sensor_data_dir + '/odometry_mu_100hz.csv', delimiter=",")
    ...
    def read_wheels_csv(self, all_in_one=None):
        ...
        if self.sensor_data_flag:
            ...
            wheels = np.loadtxt(self.sensor_data_dir + '/wheels.csv', delimiter=",")
