...
class RosSensorMsg(BaseRawData, BaseConvert):
    ...
    def wheel_odom_to_odometry(self, wheels_list, i):
        ...
        # get wheel velocity
        utime = wheels_list[self.i_wheel, 0]
    ...
    def ms25_to_imu(self, imu_list, i):
        ...
        imu.angular_velocity.x = rot_rs
        imu.angular_velocity.y = rot_ps
        imu.angular_velocity.z = rot_hs
        imu.angular_velocity_covariance = IMU_VEL_COVAR

        # linear acceleration in ned
        imu.linear_acceleration.x = accel_xs
        imu.linear_acceleration.y = accel_ys
        ...
        mag.magnetic_field.x = mag_xs
        mag.magnetic_field.y = mag_ys
    ...
    def gt_to_odometry(self, gt_list, gt_cov_list, i):
        ...
        :param gt_cov_list: list containing ground truth covariance
        :param           i: row counter
        ...
        gt.header.frame_id = self.odom_frame
        gt.child_frame_id = gt_link
