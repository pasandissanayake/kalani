...
image_file_path = "/media/entc/New Volume/data/kitti_tracklets/2011_09_26/2011_09_26_drive_0027_sync/image_02_points"
velodyne_file_path = "/media/entc/New Volume/data/kitti_tracklets/2011_09_26/2011_09_26_drive_0027_sync/velodyne_points/data"
label_file_path = "/media/entc/New Volume/DATASETS/Detection-KITTI/data_object_label_2/training/label_2"
xml_path ="/media/entc/New Volume/data/kitti_tracklets/2011_09_26/tracklet_labels.xml"
...
def talker():
    ...
    pub4 = rospy.Publisher('tracklets', Float64MultiArray, queue_size=0)
    ...
    while not rospy.is_shutdown():
        for i in range(len(left_imgs)):
            ...
            data_to_send.data = tracklets[i] # assign the array with the value you want to send
            data_to_send.header.stamp = ts
